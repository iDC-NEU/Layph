...
#ifndef ANALYTICAL_APPS_BFS_BFS_LAYPH_H_
#define ANALYTICAL_APPS_BFS_BFS_LAYPH_H_
...
class BFSLayph : public TraversalAppBase<FRAG_T, VALUE_T> {
 public:
...
#endif  // ANALYTICAL_APPS_BFS_BFS_LAYPH_H_
